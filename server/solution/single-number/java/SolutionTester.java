        ...
        try {
            ...
            try {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (!testResult) {
                        String content = "[Fail]Failed at: Input: " + Arrays.toString(nums) + "; Your answer:" + ret + "; Expected answer: " + expected;
                        System.out.println("[Fail]" + Arrays.toString(nums) + ";" + ret + ";" + expected);
